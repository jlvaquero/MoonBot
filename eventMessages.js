...
const telegramEventMessages = {
  ...
  [GameEvents.gameCreated]: "Game created. You and other group members can /joingame.",
  ...
  [GameEvents.gameNumBitsMissed]: "How many bits should have the computer's registers?",
  [GameEvents.gameNumBugsMissed]: "How many bugs should have the computer's code?",
  [GameEvents.gameMaxEnergyMissed]: "How many enrgy points should the players have?",
  [GameEvents.gameUseEventsMissed]: "Should game events be used?",
